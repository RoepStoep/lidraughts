...
set apps=site chat cli swiss challenge notify round analyse editor puzzle lobby tournament tournamentSchedule tournamentCalendar externalTournament simul dasher speech palantir
