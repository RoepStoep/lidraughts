...
val `inYourLocalTimezone` = new Translated("inYourLocalTimezone", Site)
val `tournChat` = new Translated("tournChat", Site)
val `noChat` = new Translated("noChat", Site)
val `onlyTeamLeaders` = new Translated("onlyTeamLeaders", Site)
val `onlyTeamMembers` = new Translated("onlyTeamMembers", Site)
...
val `tieBreakX` = new Translated("tieBreakX", Swiss)
val `nextRound` = new Translated("nextRound", Swiss)
val `numberOfRounds` = new Translated("numberOfRounds", Swiss)
val `numberOfRoundsHelp` = new Translated("numberOfRoundsHelp", Swiss)
...
val `tournStartDate` = new Translated("tournStartDate", Swiss)
val `roundInterval` = new Translated("roundInterval", Swiss)
val `forbiddenPairings` = new Translated("forbiddenPairings", Swiss)
val `forbiddenPairingsHelp` = new Translated("forbiddenPairingsHelp", Swiss)
val `newSwiss` = new Translated("newSwiss", Swiss)
