...
val `microMatches` = new Translated("microMatches", Site)
...
val `microMatchWin` = new Translated("microMatchWin", Site)
val `microMatchLoss` = new Translated("microMatchLoss", Site)
val `microMatchDraw` = new Translated("microMatchDraw", Site)
...
val `viewTheGames` = new Translated("viewTheGames", Site)
...
val `draughtsTitle` = new Translated("draughtsTitle", Site)
...
val `viewAllResults` = new Translated("viewAllResults", Site)
val `latestResults` = new Translated("latestResults", Site)
val `upcomingGames` = new Translated("upcomingGames", Site)
val `nowPlaying` = new Translated("nowPlaying", Site)
...
val `viewX` = new Translated("viewX", Site)
...
val `autoStartsAtX` = new Translated("autoStartsAtX", Site)
...
val `gameStarted` = new Translated("gameStarted", Site)
val `gameCanceled` = new Translated("gameCanceled", Site)
...
val `roundX` = new Translated("roundX", Swiss)
...
val `pleaseReadTheFollowingCarefully` = new Translated("pleaseReadTheFollowingCarefully", External)
val `youHaveBeenAssignedFmjdIdX` = new Translated("youHaveBeenAssignedFmjdIdX", External)
val `contactTournamentOrganizerXIfNotYourId` = new Translated("contactTournamentOrganizerXIfNotYourId", External)
val `fmjdProfileInformationWillBeVisible` = new Translated("fmjdProfileInformationWillBeVisible", External)
val `fmjdProfile` = new Translated("fmjdProfile", External)
